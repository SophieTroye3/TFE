...
<html>
<head>
    <title>Guided Tour | VIT | TFE Sophie Troye</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header>
        <div id="header_container">
            ...
            <h1 id="guided_h1">Guided Tour</h1>
            <p id="punchline_guided">Discover VIT</p>
        </div>
        <div id="menus">
        <!--<ul class="social">
                <a href="#"><li></li></a>
        ...
        <div id="menu_space">
            <ul>
                ...
                <a href="guided.php"><li class="active_menu">Guided tour</li></a>
            </ul>
        </div>
        </div>
    ...
    <section id="pro_content">
        ...
        <div id="more">
            <h4>You want to know more about VIT ?</h4>
            <p>Watch this teaser to dive into the world of VIT and all the incredible features :</p>
        </div>
        
       <video controls poster="img/guided_cover.png" src="video/guided.mp4" class="vid_guided">Guided Tour of VIT</video>
