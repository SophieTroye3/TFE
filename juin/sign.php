...
<html>
<head>
    <title>Sign up | VIT | TFE Sophie Troye</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header>
        <div id="header_container">
            ...
            <p id="punchline">enjoy all the features of VIT</p>
        </div>
        <div id="menus">
        <!--<ul class="social">
                <a href="#"><li></li></a>
    ...
    <section id="sign_content">
        <p>Sign up now and enjoy all the features of Very Important Ticket. <br>Save your favorites, stay aware of upcoming shows and many more !</p>
        <div id="line"></div>
    ...
    <div>
        <label for="sign_email">E-mail :</label>
        <input type="text" id="sign_email" />
    </div>
    <button type="submit" id="sign_submit">Send</button>
    </form>
    <p class="sorry">Sorry but registration is not available at the moment.</p>
