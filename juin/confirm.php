...
<html>
<head>
    <title>Welcome ! | VIT | TFE Sophie Troye</title>
    <meta charset="UTF-8">
...
<body>
    ...
    $sql = "UPDATE newsletter SET confirmed=1 WHERE code='".$ccode."'";
    // Prepare statement
    ...
    <header>
        <div id="header_container">
            ...
            <p id="punchline">You are now on our mailing list</p>
        </div>
        <div id="menus">
        <!--<ul class="social">
                <a href="#"><li></li></a>
    ...
    <section id="pro_content">
        ...
        <?php
        if ($stmt->rowCount()<1) {
            echo "<div class='text_confirm'><p>You have already confirmed your subscription.</p><a href='index.php'>Go to the homepage</a></div>";
        } else {
            echo "<div class='text_confirm'><p>Thanks for subscribing ! You'll receive all the news from VIT.</p><a href='index.php'>Go to the homepage</a></div>";
        }
        $conn = null;
        ?>
